...
import 'package:andeanvalleysystem/modules/module_llenado_despacho.dart';
...
class ModuleDespachoPedidos extends StatefulWidget {
  @override
  _ModuleDespachoPedidosState createState() => _ModuleDespachoPedidosState();
}

class _ModuleDespachoPedidosState extends State<ModuleDespachoPedidos> {
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => ModuleLlenadoDespachos(proforma: p,items: it, idUser: idUser, refreshAll: setState,),));
              },
            ),
            TextButton(
              child: Text('CANCELAR'),
