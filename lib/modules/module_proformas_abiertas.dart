...
class ModuleProformasAbiertas extends StatefulWidget {
  @override
  _ModuleProformasAbiertasState createState() => _ModuleProformasAbiertasState();
}

class _ModuleProformasAbiertasState extends State<ModuleProformasAbiertas> {
  ...
  Future getData()async{
    ...
    proformas = await ApiProformas().get();
    ...
    itemsList.forEach((element) {
      if(items.containsKey(element.idProforma)){
        ...
        CantidadesTotales[element.idProforma] += element.pesoNeto * element.cantidad;
      }else{
                              ...
                              Expanded(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    WidgetHeaderList(text: "PROFORMA",flex: 1,func: (){
                                      refreshList((){
                                    ...
                                    WidgetHeaderList(text: "MONTO TOTAL\n[Bs]",flex: 1,func: (){},),
                                  ],
                                ),
                              ),
                              Expanded(
                                      ...
                                      return Scrollbar(
                                        ...
                                        child: ListView.separated(
                                          ...
                                          itemBuilder: (context, index) {
                                            ...
                                            List<String> fec = p.fec_creacion.split('-');
                                            return InkWell(
                                              onTap: (){
                                                _showDialog(p);
                                              },
                                              child: Row(
                                                children: [
                                                  ...
                                                  Expanded(flex:2,child: Container(
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          Text(NumberFunctions.formatNumber(CantidadesTotales[p.id], 3)),
                                                        ],
                                                      ))),
                                                  Container(
                                                    width: 1,
          ...
          actions: <Widget>[
            TextButton(
              ...
              onPressed: () {
                ...
                js.context.callMethod('open', ['${ApiConnections().url}pdf/generateProf/${p.id}/$nameString']);
              },
            ),
            TextButton(
              child: Text('EDITAR'),
            ...
            Align(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  ...
                  ApiProformas().aceptar(p, p.id).whenComplete((){
                    refreshAll((){
